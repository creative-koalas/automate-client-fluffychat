        ...
        builder: (context, isHovered) => AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: activeChat
                ? FluffyThemes.layeredShadow(context,
                    elevation: FluffyThemes.elevationMd)
                : isHovered
                    ? FluffyThemes.shadow(context,
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) => HoverBuilder(
                builder: (context, listTileHovered) => ListTile(
                  ...
                  onLongPress:
                      isDesktop ? null : () => onLongPress?.call(context),
                  leading: HoverBuilder(
                    builder: (context, hovered) => AnimatedScale(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          borderRadius:
                              BorderRadius.circular(FluffyThemes.radiusFull),
                          boxShadow: hovered
                              ? FluffyThemes.shadow(context,
                                  elevation: FluffyThemes.elevationSm)
                              : null,
                              ...
                              if (currentSpace != null)
                                Positioned(
                                  ...
                                  child: Avatar(
                                    ...
                                    name:
                                        currentSpace.getLocalizedDisplayname(),
                      ...
                      Expanded(
                        child: typingText.isNotEmpty
                            ...
                            : FutureBuilder(
                                ...
                                future: lastEvent != null && needLastEventSender
