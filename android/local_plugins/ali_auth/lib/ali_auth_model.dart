...
AliAuthModel _$AliAuthModelFromJson(Map<String, dynamic> json) {
  return AliAuthModel(
    ...
    json['isPrivacyAnimation'] as bool?,
    json['privacyVCIsCustomized'] as bool?,
...
Map<String, dynamic> _$AliAuthModelToJson(AliAuthModel instance) =>
    <String, dynamic>{
      ...
      'isPrivacyAnimation': instance.isPrivacyAnimation,
      'privacyVCIsCustomized': instance.privacyVCIsCustomized,
